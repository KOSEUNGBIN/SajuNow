...
public class CompanyQuestion extends BaseModel {

	
	/**
	 *  Q&A Entity
	 */
	private static final long serialVersionUID = 6182796256729653370L;
	...
	public CompanyQuestion(long question_no, String title, String content, String register_date) {
		super();
