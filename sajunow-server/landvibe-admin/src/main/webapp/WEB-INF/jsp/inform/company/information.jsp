...
<div class="container-fluid"
	...
	<h1>역술인 공지사항 목록</h1>
	<p>
		<strong>해당 제목을 클릭하시면 역술인 공지사항으로 이동할 수 있습니다.</strong>
	</p>
</div>
	...
	<div class='col-md-8' style="overflow-x: auto;">
					...
					<tbody>
						...
						<c:forEach var='item' items="${questionList}">
							<tr>
								...
								<td>관리자</td>
								<td><a href="/inform/company/modify/${item.question_no}">${item.title}</a></td>
		...
		<div class='row'>
			...
			<div class='col-md-3'
				...
				<a type="button" class="btn btn-primary btn-lg" href='/inform/company/add'>추가하기</a>
			</div>
		</div>
