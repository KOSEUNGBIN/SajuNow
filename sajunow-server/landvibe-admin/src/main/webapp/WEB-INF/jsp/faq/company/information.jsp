...
<div class="container-fluid"
	...
	<h1>역술인 FAQ 목록</h1>
	<p>
		<strong>해당 제목을 클릭하시면 역술인 FAQ으로 이동할 수 있습니다.</strong>
	</p>
</div>
	...
	<div class='col-md-8' style="overflow-x: auto;">
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<c:forEach var='item' items="${faqList}">
							<tr>
								<th scope="row">${item.faq_no}</th>
								<td>관리자</td>
								<td><a href="/faq/company/modify/${item.faq_no}">${item.title}</a></td>
		...
		<div class='row'>
			...
			<div class='col-md-3'
				...
				<a type="button" class="btn btn-primary btn-lg" href='/faq/company/add'>추가하기</a>
			</div>
		</div>
