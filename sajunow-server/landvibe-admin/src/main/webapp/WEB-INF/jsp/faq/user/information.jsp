...
<div class="container-fluid"
	...
	<h1>사용자 FAQ 목록</h1>
	<p>
		<strong>해당 제목을 클릭하시면 사용자 FAQ으로 이동할 수 있습니다.</strong>
	</p>
</div>
	...
	<div class='col-md-8' style="overflow-x: auto;">
					...
					<tbody>
						...
						<c:forEach var='item' items="${faqList}">
							<tr>
								...
								<td>관리자</td>
								<td><a href="/faq/user/modify/${item.faq_no}">${item.title}</a></td>
		...
		<div class='row'>
			...
			<div class='col-md-3'
				...
				<a type="button" class="btn btn-primary btn-lg" href='/faq/user/add'>추가하기</a>
			</div>
		</div>
